...
public:
    ...
    IsoLayerGeneration() { std::cout << "please intilize thr m_tetMesh" << std::endl; };
    ~IsoLayerGeneration() {};
    ...
    void _installLayerDis_toNode(QMeshPatch* lastlayer, QMeshPatch* thislayer);
    void _installLayerDis_toNode(PolygenMesh* isosurfaceset);
...
private:
    ...
    void _checkLayerDistance(QMeshPatch* bLayer, QMeshPatch* tLayer, PQP_Model* pqpModel);
